...
const data = [
 {
  id: 1,
  desc:'At abule oja second gate enter a keke going to unilag junction and stop at moore road, it is #100',
  landmarks: [
...
<>
    ...
    <p className="text-center uppercase mt-2">Abule oja to Moore road</p>
